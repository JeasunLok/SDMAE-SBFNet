...
from compared_models import Compared_Models
...
if __name__ == "__main__":
    ...
    model_selection = Compared_Models()
    model = model_selection.get_model(n_channels=3, n_classes=num_classes, model=model_type)
...
# torchrun --master_port 29501 --nproc_per_node=2 train_compared_models.py
