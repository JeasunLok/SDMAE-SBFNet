    ...
    for batch_idx, (batch_data, batch_data_hsv, batch_label) in loop:
        ...
        if fp16:
            with torch.cuda.amp.autocast():
                batch_prediction = model(batch_data, batch_data_hsv)
...
if __name__ == "__main__":
    ...
    model = SDSBFNet_1(model.encoder, out_channels=num_classes, downsample_factor=16)
...
# torchrun --nproc_per_node=2 train_SDSBFNet_ablation_noGSBM.py
